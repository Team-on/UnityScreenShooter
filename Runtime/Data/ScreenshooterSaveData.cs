...
public class ScreenshooterSaveData {
	...
	public List<ScreenshotData> screenshoots = new List<ScreenshotData>(1) {
		new ScreenshotData("FullHD", new Vector2(1920, 1080)),
		new ScreenshotData("FullHD", new Vector2(1920, 1080)){ captureOverlayUI = false},
		new ScreenshotData("FullHD", new Vector2(1920, 1080)){ targetCamera = ScreenshooterTargetCamera.SceneView },
	};
